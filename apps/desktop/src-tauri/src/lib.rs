...
fn create_specta_builder() -> Builder<tauri::Wry> {
    Builder::<tauri::Wry>::new().commands(collect_commands![
        ...
        commands::settings::open_skills_directory,
        ...
        commands::profile::create_teacher_profile,
        ...
        commands::execution::execute,
        commands::execution::execute_stream,
        commands::execution::execute_from_chat_input,
